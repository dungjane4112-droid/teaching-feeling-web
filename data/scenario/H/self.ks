...
*set
[chara_00]
[if exp="f.hat==1" ][chara_mod name="hat" time="0" storage="H/self/hat/a1.gif" ]
...
;;初回
*H_self_first
[if exp="f.sexless_anim==1"][jump storage="H/self_old.ks" target="*H_self_first"][endif]
[cm][stop_bgm][black]…[p][show_message_w]
[bg_door]
[_]（Mở cửa phòng ra, hình như Sylvie không có ở troq này。[p]
...
[syl]Ohh…Ahh…Uhh[p]
[black][call target="*set" ][hair_fself][pinself][hair_bself][ribbon_self][bgm_MT][set_black][reset_effect]
[bg time="1" method="crossfade" storage="H/auto1.jpg" ]
[call target="*bga1_"]
...
[call target="*bga3_"][bg time="1" method="crossfade" storage="H/auto2.jpg" ]
...
;;2回目以降
*H_self
[if exp="f.sexless_anim==1"][jump storage="H/self_old.ks" target="*H_self"][endif]
[cm][stop_bgm][black]…[p][show_message_w][bgm_MT]
[black][call target="*set" ][hair_fself][pinself][hair_bself][ribbon_self]
[bgm_MT][set_black][reset_effect][reset_effect]
...
[set_black][bg time="1" method="crossfade" storage="H/auto1.jpg" ]
[call target="*bgb1_"]
...
[call target="*bgb7_"][bg time="1" method="crossfade" storage="H/auto2.jpg" ][se_nloop st="squi.ogg" ]
...
[eval exp="f.heavn=f.heavn+1" ][black][chara_00][jump storage="H/before.ks" target="*self_after" ]
...
;;-------------------------------------------------------------------------------------------------------
*bga1_
[mod_body st="H/self/body/b2.png" ]
[mod_face st="H/self/face/a1.png" ]
[mod_head st="H/self/body/h2.png" ]
[mod_cg3 st="H/self/ef2/2.png" ]
[return]
*bga2_
[mod_body st="H/self/body/b2.png" ]
[mod_face st="H/self/face/a2.png" ]
[mod_head st="H/self/body/h2.png" ]
[mod_cg3 st="H/self/ef2/squi.png" ]
[return]
*bga3_
[mod_body st="H/self/body/b2.png" ]
[mod_face st="H/self/face/a3.png" ]
[mod_head st="H/self/body/h2.png" ]
[mod_cg3 st="H/self/ef2/2.png" ]
[bg time="1" method="crossfade" storage="H/auto2.jpg" ]

[return]
*bga4_
[mod_body st="H/self/body/b2.png" ]
[mod_face st="H/self/face/a4.png" ]
[mod_head st="H/self/body/h2.png" ]
[mod_cg3 st="H/self/ef2/2.png" ][return]
*bgb1_
[mod_body st="H/self/body/b2.png" ]
[mod_face st="H/self/face/b1.png" ]
[mod_head st="H/self/body/h2.png" ]
[mod_cg3 st="H/self/ef2/2.png" ]
[return]
*bgb2_
[mod_body st="H/self/body/b2.png" ]
[mod_face st="H/self/face/b2.png" ]
[mod_head st="H/self/body/h2.png" ]
[mod_cg3 st="H/self/ef2/2.png" ]
[return]
*bgb3_
[mod_body st="H/self/body/b2.png" ]
[mod_face st="H/self/face/b3.png" ]
[mod_head st="H/self/body/h2.png" ]
[mod_cg3 st="H/self/ef2/2.png" ]
[return]
*bgb4_
[mod_body st="H/self/body/b2.png" ]
[mod_face st="H/self/face/b4.png" ]
[mod_head st="H/self/body/h2.png" ]
[mod_cg3 st="H/self/ef2/2.png" ]
[return]
*bgb5_
[mod_body st="H/self/body/b2.png" ]
[mod_face st="H/self/face/b5.png" ]
[mod_head st="H/self/body/h2.png" ]
[mod_cg3 st="H/self/ef2/2.png" ]
[return]
*bgb6_
[mod_body st="H/self/body/b2.png" ]
[mod_face st="H/self/face/b6.png" ]
[mod_head st="H/self/body/h2.png" ]
[mod_cg3 st="H/self/ef2/2.png" ][return]
*bgb7_
[mod_body st="H/self/body/b2.png" ]
[mod_face st="H/self/face/b7.png" ]
[mod_head st="H/self/body/h2.png" ]
[mod_cg3 st="H/self/ef2/squi.png" ]
[return]
*bgb8_
[mod_body st="H/self/body/b2.png" ]
[mod_face st="H/self/face/b8.png" ]
[mod_head st="H/self/body/h2.png" ]
[mod_cg3 st="H/self/ef2/2.png" ][return]
