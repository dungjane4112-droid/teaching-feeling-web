...
[link target=*a_a]【通常】[endlink]_[link target=*a_b]【メガネ】[endlink]_
[link target=*a_c]【ケモミミ】[endlink]_[link target=*a_d]【メガネ+ケモミミ】[endlink][r]
[link target=*end_video]【やめる】[endlink]
...
*end_video
[cm][stop_movie]
[stopbgm][stopse][black][return_memory]
