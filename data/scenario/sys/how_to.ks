...
[button target="*act_win" graphic="how_to/act_win.png" x="10" y="181" ][else]
[button target="*act_win" graphic="how_to/act_win-.png" x="10" y="181" ][endif]
[if exp="f.memory=='hw_sub_win'" ]
[button target="*sub_win" graphic="how_to/sub_win.png" x="10" y="237" ][else]
[button target="*sub_win" graphic="how_to/sub_win-.png" x="10" y="237" ][endif]
[if exp="f.memory=='hw_dress_up'" ]
[button target="*dress_up" graphic="how_to/dress_up.png" x="10" y="293" ][else]
[button target="*dress_up" graphic="how_to/dress_up-.png" x="10" y="293" ][endif]
[if exp="f.memory=='hw_out'" ]
[button target="*out" graphic="how_to/out.png" x="10" y="349" ][else]
[button target="*out" graphic="how_to/out-.png" x="10" y="349" ][endif]
[if exp="f.memory=='hw_status'" ]
[button target="*status" graphic="how_to/status.png" x="10" y="405" ][else]
[button target="*status" graphic="how_to/status-.png" x="10" y="405" ][endif]
[if exp="f.memory=='hw_bed'" ]
[button target="*bed" graphic="how_to/bed.png" x="10" y="461" ][else]
[button target="*bed" graphic="how_to/bed-.png" x="10" y="461" ][endif]

[if exp="f.memory=='hw_memory'" ]
[button target="*memory" graphic="how_to/memory.png" x="10" y="559" ][else]
[button target="*memory" graphic="how_to/memory-.png" x="10" y="559" ][endif]
