;;========script_by_ichibikun============
*begin
[eval exp="f.glasses=0"][eval exp="f.ribbon=0"][eval exp="f.hat=0"][eval exp="f.neck=0"][eval exp="f.pin=0"][eval exp="f.hair_style=0"]
...
[chara_mod name="ribbon" time="0" storage="00.png" ]
;;set/前髪
[if exp="f.front_hair==1" ][chara_mod name="hair_f" time="0" storage="H/back/body/fh1_l.png" ]
