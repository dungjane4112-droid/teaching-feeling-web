...
Anh nên nghỉ ngơi một lúc đi.[lr][h_face st="H/back/face2/a2.png" ]
...
*to_next_1
[cm][eval exp="f.sexless=0"][eval exp="f.sexless_c=0"]
[h_face st="H/back/face/a3.png" ]
N-Nếu [name] đã muốn đến vậy...[lr]
[h_face st="H/back/face/a2.png" ]
[random_2]
[if exp="f.r==1"]
Em cũng sẽ phục vụ anh một lúc ạ.[p][else]
...
(Tôi không thể cưỡng lại dáng vẻ quyến rũ của Sylvie vào buổi sáng như thế này.[p] 
(Thằng nhỏ của tôi đã sẵn sàng.[p]
...
[_](Tôi cọ xát dương vật của mình lên mông và xung quanh môi âm đạo của Sylvie.[lr] 
Cô ấy bắt đầu ướt và đẩy mông ra sau như đã sẵn sàng.[p]
(Dù gì thì cũng mới sáng sớm. Tôi sẽ làm tình với nàng một cách thật nhẹ nhàng.[p]
...
[h_face st="H/back/face/a2.png" ]
Em sẽ dọn dẹp nốt nên anh hãy đi nghỉ một chút đi ạ.[p]
...
[yada_1]K-Không thể nào![lr][h_face st="H/back/face/a9.png" ]
[na_1]K-không có gì đâu ạ. Em sẽ dọn dẹp tiếp ở đây ạ...[p]
[endif]

[black][stop_bgm]
[_](Tôi rời khỏi khu bếp, ra ngoài đợi Sylvie.[p]
...
[f/sp]B-Buổi sáng...Thật tuyệt ạ.[p_]
[f/q_nt]
[if exp="f.play=='out'"][_]
...
(Thôi, ra ngoài đợi Sylvie rửa chén xong vậy.[p]
[if exp="f.play=='out'"][dress_random][call target="*off_c"][endif]
...
[syl]...[um_01]Um~! [name][lr_]
[f/clp]..K-không có gì đâu ạ![p_]
[f/sp]S-Sáng nay...[l_][f/sp]chúng ta...[l_][f/sp]thật tuyệt ạ!.[p_][f/sq_nt]
[if exp="f.play=='out'"][_]
(Trang phục của Sylvie?...[lr]
À, chắc lại tôi 'ra' trên đó lúc nãy.[p]
[eval exp="f.play=0"]
...
*end
[cm][eval exp="f.play=0"][eval exp="f.wet=0"][if exp="f.dress==0"][eval exp="f.dress=f.dress_save"][eval exp="f.dress_save=0"][endif]
[black][stop_bgm]
(Thôi, ra ngoài đợi Sylvie rửa chén xong vậy.[p]
[eval exp="f.lunch_check=1"]
[set_black][chara_00][chara_hide_all]
