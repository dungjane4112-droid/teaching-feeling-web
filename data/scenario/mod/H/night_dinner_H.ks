;;========script_by_ichibikun============
*begin
[cm][black][chara_00][stop_bgm][bgm_MT]
...
[if exp="f.neck>=11 && f.neck<=20"][else]
[call target="*set_n"][endif]
[jump target="*to_next"]
...
*to_next
[layermode graphic="effect/H/kitchen_n.png" time="0" mode="overlay" wait="false" ]
...
Ah？！[name]。Có chuyện gì vậy?。[p]
[_]（Cơ thể Sylvie khẽ giật mình khi tôi lặng lẽ tiếp cận cô ấy từ phía sau。[p]
[h_face st="H/back/face2/a1.png" ]
[syl][na_1]Em đang rửa chén mà! [name]…。[p]
[h_face st="H/back/face/a3.png" ]
Anh đợi em xong việc nhé.[lr][h_face st="H/back/face2/a2.png" ]
...
*to_next_1
[cm][eval exp="f.sex_kitchen='yet'"][eval exp="f.sexless=0"][eval exp="f.sexless_c=0"]
[h_face st="H/back/face/a2.png" ]
N-Nếu [name] đã muốn đến vậy...[lr]
[h_face st="H/back/face/a3.png" ]
[random_2]
[if exp="f.r==1"]
Em cũng sẽ phục vụ anh ở đây luôn ạ.[p][else]
Thì anh hãy tiếp tục đi ạ.[p][endif]
[h_face st="H/back/face/a4.png" ]
[_](...[p]
[h_body st="H/back/body/uncen/b0.png" ]
[h_face st="H/back/face/a5.png" ]
(Tôi không thể chờ đợi thêm nữa. thằng nhỏ của tôi đã sẵn sàng.[p]
...
[_](Tôi chà nhẹ thằng nhỏ của mình lên mông và xung quanh môi âm đạo của Sylvie.[lr] 
Cô ấy đã khá là ướt và thằng nhỏ của tôi cũng rất cứng rồi.[p]
...
[button target="*sex_hard" graphic="Hx/sex_hard.png" x="179" y="126" ][endif]
...
[elsif exp="f.r==2"]
(Cơ thể Sylvie khẽ run lên và âm đạo cô ấy hút chặt lấy thằng nhỏ của tôi.[r]
...
[l_13]
(Âm đạo sylvie vẫn không ngừng trở nên ẩm ướt, cô ấy đang tận hưởng dư âm của việc lên đỉnh.[p]
[eval exp="f.s_feel=f.s_feel-200"][eval exp="f.y_feel=f.y_feel+20"]
[if exp="f.wet>=1500"][jump target="*end_wet"][endif]
[jump target="*choice"]
...
*stop
[cm]
[stopse][eval exp="f.sylvie_play='stop'"]
...
[elsif exp="f.r==13" ]
[l_04]（Chân sylvie đóng lại, siết chặt dương vật của tôi.[p]
...
[elsif exp="f.r==15" ]
[l_11](Tiếng ồn mỗi khi hông của tôi và mông cô ấy chạm vào nhau[p_]
...
*end_non
[cm][if exp="f.dress==0"][eval exp="f.dress=f.dress_save"][eval exp="f.dress_save=0"][endif]
...
K-Không có gì đâu ạ![l][h_face st="H/back/face/a5.png" ]
Em sẽ tiếp tục công việc ở đây.[p]
[else]
[h_face st="H/back/face/a2.png" ]
[syl][eh_01]Eh~?[lr][h_face st="H/back/face/a6.png" ]
Đã xong rồi ư?...[p][h_face st="H/back/face/b7.png" ]
[yada_1]K-Không thể nào![l][h_face st="H/back/face/a9.png" ]
[na_1]K-không có gì đâu ạ. Em sẽ dọn dẹp tiếp ở đây ạ...[p]
[endif]
...
[_](Tôi rời khỏi khu bếp, ra ngoài chuẩn bị đi tắm.[p]
[jump storage="mod/bath_af.ks" target="*begin"]
...
[black][stop_bgm]
[eval exp="f.wet=0"]
[if exp="f.play=='out'"][dress_random][call target="*off_c"][endif]
...
[else][_](Thôi, ra ngoài đợi chuẩn bị đi tắm thôi.[p]
[set_black][chara_00][chara_hide_all]
...
[eval exp="f.play=0"][eval exp="f.lunch_check=1"]
[if exp="f.bath=='yet'"]
[jump target="*non_bath"]
[else][_](Thôi, ra ngoài đợi chuẩn bị đi tắm thôi.[p]
[set_black][chara_00][chara_hide_all]
...
*end_wet
[cm][if exp="f.dress==0"][eval exp="f.dress=f.dress_save"][eval exp="f.dress_save=0"][endif]
[syl][h_face st="H/back/face/a2.png" ][na_1]À~Nou! [name] à![lr]
[h_face st="H/back/face/a3.png" ]Chúng ta dừng lại ở đây thôi ạ.[p]
[h_face st="H/back/face/a4.png" ]Em cần dọn dẹp ở đây nên không thể làm tiếp lúc này được đâu.[p]
[black][stop_bgm][eval exp="f.wet=0"]
[eval exp="f.play=0"]
[eval exp="f.lunch_check=1"]
[if exp="f.bath=='yet'"]
...
*dress_on
[cm]
[eval exp="f.dress=f.dress_save][eval exp="f.dress_save=0"][call target="*set_neck"][hide_black]
[chara_mod name="window" time="0" storage="o/win/H_dinner.png"]
