...
[if exp="f.wet>=1500 && f.lust>=250"][jump target="*end_wet"]
[elsif exp="f.wet>=1200 && f.lust>=200"][jump target="*end_wet"]
[elsif exp="f.wet>=900 && f.lust>=100"][jump target="*end_wet"]
[elsif exp="f.wet>=500 && f.lust<=99"][jump target="*end_wet"]
[endif]
[jump target="*choice"]
...
*end
[cm][if exp="f.play=='out'"][dress_random][call target="*off_c"][endif]
...
*dress_on
[cm]
[eval exp="f.Hx_dress=1"][eval exp="f.Hx_neck=1"][eval exp="f.Hx_ribbon=1"][eval exp="f.Hx_glasses=1"][eval exp="f.Hx_pin=1"][call target="*set"][call target="*set_neck"][hide_black]
[chara_mod name="window" time="0" storage="o/win/H_dinner.png"]
[chara_show name="window" time="10" left="0.1" zindex=175][jump target="*choice"]

*dress_off
[cm]
[eval exp="f.Hx_dress=0"][chara_mod name="dress" time="350" storage="00.png"]
[jump target="*choice"]

*neck_off
[cm]
[eval exp="f.Hx_neck=0"][chara_mod name="neck" time="350" storage="00.png"]
[jump target="*choice"]

*ribbon_off
[cm][eval exp="f.Hx_ribbon=0"][chara_mod name="ribbon_b" time="300" storage="00.png" ][chara_mod name="hair_b" time="100" storage="H/back/hair/nr_.png" ][chara_mod name="ribbon" time="100" storage="H/back/hair/nr.png" ]
[jump target="*choice"]

*glass_off
[cm][eval exp="f.Hx_glasses=0"][mod_glasses st="00.png" ][jump target="*choice"]

*pin_off
[cm] [chara_mod name="pin" time="0" storage="00.png" ][chara_mod name="hair_f" time="0" storage="H/back/body/fh.png" ]
[eval exp="f.Hx_pin=1"][jump target="*choice"]
