...
T-thực sự thì[wait time="300"].[wait time="300"].[wait time="300"].
...
Cô ấy chỉ hơi nhìn theo tay tôi một chút với một nụ cười ngọt ngào [r]thoáng trên môi[p][endif]
[aurel]
...
[if exp="f.aur_memo_1>=2"][else][eval exp="f.aur_memo_1=2"][endif]
[jump storage="mod/dream.ks" target="*dream_aurelia_beore"]
[s]
