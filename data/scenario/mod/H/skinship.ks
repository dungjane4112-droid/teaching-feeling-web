...
[if exp="f.dress<=0 || f.cloth_off=='true' || f.dress_ship=='off' || f.dress<=1000 && f.dress>=1019"]
...
[clickable width="95" height="30" x="326" y="751" storage="mod/H/skinship.ks" target="*pus_down" border="" ]
[elsif exp="f.dress>=1000 && f.dress<=1019 && f.pants_ship=='off'" ]
[clickable width="95" height="30" x="326" y="751" storage="mod/H/skinship.ks" target="*pus_down" border="" ]
[endif]
...
*pus_up_l
[cm][if exp="f.ht_mlem=='n' || f.hp_mlem=='n' || f.ht_mlem=='b'"][else][chara_mod name="hand_R" time="0" storage="00.png" ][endif]
...
[eval exp="f.wet=f.wet+5"][endif]
[if exp="f.under_p<=0 || f.pants_ship=='off'"]
[chara_mod name="breath" time="0" storage="mod/hand/lick_manko.png" ][else]
