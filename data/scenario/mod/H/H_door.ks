;;========script_by_ichibikun============
*begin
[cm][black][chara_00][stop_bgm][bgm_MT][eval exp="f.sex_door='non'"]
...
*show_set
[bg time="1" method="crossfade" storage="bg/mod/bg_door_x.jpg" ]
...
[syl][kya_01]Kya~！?[p]
[h_face st="H/back/face/a1.png" ][h_ef st="00.png" ]
Ah？！[name]。[p][h_face st="H/back/face/a2.png" ]
[_]（Sylvie giật mình khi tôi đột ngột kéo cô ấy đến góc tường gần cửa ra vào。[p]
[syl][na_1]E-Em chỉ nói đùa thôi, [name]…。[lr]
[h_face st="H/back/face2/a1.png" ]
N-Nếu làm vậy ở đây thì...[l]Sẽ bị phát hiện mất.[p]
[h_face st="H/back/face/a2.png" ]
Chúng ta nên ăn tối trước đi ạ.[p_]
...
*to_next_1
[cm][eval exp="f.sex_door='yet'"][eval exp="f.sexless=0"][eval exp="f.sexless_c=0"]
...
[h_face st="H/back/face/a2.png" ]
Chúng ta nhanh vào ăn tối thôi ạ.[p]
[jump target="*end_"]
...
*bat
[cm][black][if exp="f.dress==0"][eval exp="f.dress=f.dress_save"][eval exp="f.dress_save=0"][endif][set_stand][bg time="400" method="crossfade" storage="bg/door_n.jpg" ]
[f/s_nt][show_stand]
[syl]
...
Đã xong rồi ư?...[p]
[h_face st="H/back/face/a9.png" ]
[na_1]K-không có gì đâu ạ. Chúng ta nhanh vào ăn tối thôi ạ...[p]
[endif]
[if exp="f.Hx_dress==0"][eval exp="f.dress=0"][endif][stopbgm]
[button storage="mod/nigh_dinner.ks" target="*lunch" graphic="ch/go_home_lunch.png" x="0" y="200" ]
