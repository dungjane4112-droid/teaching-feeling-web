...
[eval exp="f.s_feel=0"][eval exp="f.under_p=0"][eval exp="f.under_b=0"]
...
[syl][na_1]E-Em chỉ vào giúp [name] tắm thôi ạ…。[p]
...
[jump storage="mod/bath_def.ks" target="*bath_with"]
[black]
