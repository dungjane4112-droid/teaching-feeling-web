...
[eval exp="f.hair_style=0"][eval exp="f.hair_band=0"][eval exp="f.pin=0"][eval exp="f.neck=0"][return]

*lunch
[if exp="f.play=='out']
[eval exp="f.play=0"]
[call target="*dress_random"][endif]
[cm][black][if exp="f.dress==9004 || f.dress==9005"][eval exp="f.talk='non'"][else][eval exp="f.talk=0"][endif]
[_]Tôi cùng sylvie tới bàn ăn.[p]
...
[f/sp][sm_05]Vừa rồi "làm" dữ dội vậy mà cũng chưa làm anh tỉnh ngủ à~♥[p_]
[elsif exp="f.r==2"]
[f/p]Anh thấy ổn chứ [name].[p_]
[f/sp]Bữa sáng sẽ giúp anh nạp lại năng lượng cho "vừa rồi" đó.[p_]
[elsif exp="f.r==3"]
...
[f/ssp]Có lẽ do "vừa rồi" hơi quá sức chăng![sm_09][p_]
[endif]
[f/s]
