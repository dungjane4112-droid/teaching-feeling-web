...
*bath_with_
[cm][eval exp="f.bath_alone='non'"][eval exp="f.bath='yet'"]
[f/p_nt][a_02]??[lr_]
...
[endif]
;[if exp="f.aur_av==1"][eval exp="f.aur_av=0"][endif]
[jump target="*bath_with"]

*bath
[black][eval exp="f.bath='yet'"]
[chara_00]
...
[if exp="f.aur_av==1"][eval exp="f.aur_av=0"]
[jump target="*bath_def_av"][endif]
...
[if exp="f.aur_av==1"][jump target="*h_j"][endif]
...
[black][stopbgm]
[if exp="f.aur_av==1"][eval exp="f.aur_av=0"][jump target="*syl_av"][endif]
[_](...
[dress_random]
...
[eval exp="f.hair_band=0"][eval exp="f.hair_style=0"][eval exp="f.pin=0"][eval exp="f.socks=0" ][eval exp="f.neck=0"][eval exp="f.gloves=0"][eval exp="f.hat=0"]
[eval exp="f.front_hair=4"]
[set_dress][set_under_dress]
[chara_mod name="socks" time="0" storage="00.png" ][f/p_nt][bg time="0" method="crossfade" storage="bg/mod/bg_bath_01.jpg" ]
[f/sp_nt][call target="*show_dress"][syl]
[um_10]Umm...[l][f/sclp_nt][name] đã tắm xong rồi à?[p_]
[f/sp_nt]Anh cứ nghỉ một lúc nhé![lr_]
[f/sclp_nt]Em sẽ tắm một lúc ạ[sm_09][p_]
...
*syl_av
[black](.[wait time="500"].[wait time="500"].[wait time="500"][cm]
[_](Hôm nay, tôi đã khá mệt sau khi từ chỗ Aurelia về.[lr]
Tôi nghĩ mình không thể tiếp tục nên đã từ chối Sylvie...[p]
[eval exp="f.dress=0"]
[random_2]
[if exp="f.r==1 && f.Dc_xa[0]=='got'"]
[eval exp="f.under_b=0"][eval exp="f.under_p=0"][eval exp="f.neck=0"]
[random_Dc_xa]
[elsif exp="f.r==2 && f.Dc_xb[0]=='got'"]
[eval exp="f.under_b=0"][eval exp="f.under_p=0"][eval exp="f.neck=0"]
[random_Dc_xb][endif]
[if exp="f.dress>=0"][else][dress_random_H][endif]

[eval exp="f.hair_band=0"][eval exp="f.hair_style=0"][eval exp="f.pin=0"][eval exp="f.socks=0" ][eval exp="f.neck=0"][eval exp="f.gloves=0"][eval exp="f.hat=0"]
[eval exp="f.front_hair=4"]
[set_black][chara_00][chara_hide_all]
[eval exp="f.under_p=0" ][eval exp="f.under_b=0" ]
[random_2][if exp="f.r==1"][random_Du_xb][else][random_Du_xc][endif]
[if exp="f.under_p>=0"][else]
[under_random_re][endif]
[random_5][if exp="f.r==4"][else][eval exp="f.under_b=0" ][endif]
...
[call target="*show_dress"][bgm_SG][syl]
[um_09][f/sclp_nt]Hmm...[p_]
