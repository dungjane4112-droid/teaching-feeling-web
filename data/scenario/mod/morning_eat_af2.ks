...
[cm]
[stopbgm][bgm_JH]
[black][if exp="f.dress==9004 || f.dress==9005"][eval exp="f.talk='non'"][else][eval exp="f.talk=0"][endif]
#
...
[if exp="f.sex_bath=='non'"]
(Sau khi rửa xong chén đĩa, Sylvie bước vào phòng tắm...[p]
[font color="lightblue"][link target="*look_bath" ]【Tới phòng tắm rình coi...】[r][r]
[link target="*wait_bath" ]【Ở đây đợi một lúc.】[resetfont][s]
[else][jump target="*out_room"][endif]

*look_bath
[cm](Tôi nhẹ nhàng tới gần phòng tắm...[p]
[eval exp="f.dress=0"][eval exp="f.pin=0"][eval exp="f.hat=0"][eval exp="f.neck=0"][eval exp="f.gloves=0"]
[jump storage="mod/bath_morning_af.ks" target="*begin"]


*wait_bath
[cm]
(Tôi ra phòng khách nghỉ ngơi một chút...[p]
[dress_random][eval exp="f.pin=0"][eval exp="f.hat=0"]
...
*out_room
[cm]
(Tôi ra phòng khách nghỉ ngơi một chút trong khi chờ Sylvie rửa chén đĩa...[p]
[set_sit][f/sp_nt][set_time][show_sit][bgm_SG]
[syl]...[um_01]Um~! [name][lr_]
[f/clp]..K-không có gì đâu ạ![p_]
[f/sp]Bữa sáng thật sự rất tuyệt ạ.[p_]
