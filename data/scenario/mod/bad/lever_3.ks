...
#Sylvie
Humm~...[p_]
[chara_mod name="h" time="50" storage="00.png" ]
#
[if exp="f.pin==0" ]
[chara_mod  name="face"  time="500"  storage="o/face/n-ctp.png" ][else]
[chara_mod  name="face"  time="500"  storage="o/face/n-ctp-.png" ][endif]
Trán của cô ấy rất nóng, cơ thể run và tái nhợt. Cô ấy đã bị [font color="0x05ffff"]cảm lạnh[resetfont].[lr_]
...
[chara_mod  name="face"  time="500"  storage="o/face/n-ctp.png" ][else]
[chara_mod  name="face"  time="500"  storage="o/face/n-ctp-.png" ][endif]
Trán của cô ấy rất nóng, mạch đập rất nhanh. Cô ấy đã bị [font color="0xff0000"]cảm nhiệt[resetfont].[lr_]
[font color="0xff0000"]Cảm nhiệt[resetfont] thật sự rất nguy hiểm, tôi cần để cô ấy nghỉ ngơi và chăm sóc cô ấy cẩn thận.[p_]
Các loại dược liệu điều chế từ "hoa xanh" có thể giúp điều trị [font color="0xff0000"]cảm nhiệt[resetfont].[p_]
[jump target="*to_next"]
;--------------------------------------to_next-----------------------------------
*to_next
[eval exp="f.bad_lv=150"]
[iscript]
f.talk=Math.floor(Math.random() * 150 + 1);
[endscript]
...
[endscript]
[if exp="f.talk==1"]
Chắc một hai ngày nữa sẽ khá hơn).[p_]
[elsif exp="f.talk==2"]
Cơn sốt của cô ấy khá cao, chắc sau vài ngày mữa mới khá hơn).[p_]
[else]
chắc sẽ sớm khỏe lại).[p_][endif]
...[p_]
#Sylvie
[chara_mod name="face" time="200" storage="mod/chara/sick.png" ]
Umm~...E..[l_]Em xin lỗi...[l_][name][lr_]
...
[elsif exp="f.talk==2"]
Em...[l_]lại gây phiền phức cho anh, [name]...[p_]
[else]
Sức khỏe của em...[l_]nó thật tệ...[p_][endif]
[chara_mod name="face" time="500" storage="mod/chara/sick_.png" ]
...
[eval exp="f.talk=f.talk+1"]
[iscript]
f.talk=Math.floor(Math.random() * 25 + 1);
[endscript]
[if exp="f.talk==1"]
[jump target="*talk1"]
[elsif exp="f.talk==2"]
...
[jump target="*talk11"]
[elsif exp="f.talk==13 || f.talk==14 || f.talk==15"]
[jump target="*talk12"]
[elsif exp="f.talk==16 || f.talk==17 || f.talk==18"]
[jump target="*talk13"]
[else]
...
#Sylvie
Trước đây,[l_] em cũng thường hay bị ốm như vậy lắm.[l_]Và đó là khoảng thời gian duy nhất em được nghỉ ngơi[p_]
[chara_mod name="face" time="600" storage="mod/chara/sick_.png" ]
...[p_]
...
[chara_mod name="face" time="300" storage="mod/chara/sick.png" ]
Đó không phải là vì...[l_] em muốn [name] bị ốm đâu...[p_]
...
Umm~!...[l_] [name]...[p_]
[chara_mod name="face" time="300" storage="mod/chara/sick.png" ]
Đừng đi đâu nhé...[l_] em...[l_]rất mệt...[p_]
[chara_mod name="face" time="300" storage="mod/chara/sick_close.png" ]
...[p_]
[jump target="*choice"]
...
Umm~!...[l_] [name]...[p_]
[chara_mod name="face" time="300" storage="mod/chara/sick.png" ]
Hãy ở bên em...[l_] em...[l_]rất mệt...[p_]
[chara_mod name="face" time="300" storage="mod/chara/sick_close.png" ]
...[p_]
[jump target="*choice"]
...
#Sylvie
...Hzzz...[l_] [name]...[lr_]
Xin anh...[l_] đừng bỏ em...[p_]
[chara_mod name="face" time="600" storage="mod/chara/sick_close_.png" ]
#
(Có vẻ Sylvie đang rất mệt, cô ấy bắt đầu mê sảng.)[p_]
[jump target="*choice"]
...
[iscript]
f.talk=Math.floor(Math.random() * 23 + 1);
[endscript]
[if exp="f.talk==1"]
[jump target="*nade1"]
[elsif exp="f.talk==2"]
...
[jump target="*nade12"]
[elsif exp="f.talk==14 || f.talk==15 || f.talk==16 || f.talk==17"]
[jump target="*nade13"]
[elsif exp="f.talk==18 || f.talk==19 || f.talk==20 || f.talk==21"]
[jump target="*nade14"]
[else]
[jump target="*nade11"]
[endif]
...
Việc bị ốm như thế này...[l_] không còn đáng sợ như trước đây nữa[p_]
[chara_mod name="face" time="600" storage="mod/chara/sick_.png" ]
...
#Sylvie
Umm~...Hzzzz![l_] [name]...[p_]
Đừng rời xa em...[l_]em sẽ làm...[l_]bất cứ thứ gì...[p_]
#
(Sylvie có lẽ đã rất mệt, cô ấy bắt đầu mê sảng.)[p_]
[chara_mod name="h" time="200" storage="mod/hand/00.png" ]
[chara_mod name="face" time="900" storage="mod/chara/sick_close_.png" ]
[jump target="*choice"]
...
#Sylvie
Umm~...Hzzzz![l_] [name]...[p_]
Đừng bỏ em lại...[l_]em sẽ luôn...[l_]nghe lời anh mà...[p_]
#
(Sylvie có lẽ đã rất mệt và bắt đầu mê sảng.)[p_]
[chara_mod name="h" time="200" storage="mod/hand/00.png" ]
[chara_mod name="face" time="900" storage="mod/chara/sick_close_.png" ]
[jump target="*choice"]
...
#Sylvie
Umm~...Hzzzz![l_] [name]...[p_]
Đừng bỏ em lại...[l_]em sợ lắm...[p_]
#
(Sylvie đã rất mệt và bắt đầu mê sảng.)[p_]
[chara_mod name="h" time="200" storage="mod/hand/00.png" ]
[chara_mod name="face" time="900" storage="mod/chara/sick_close_.png" ]
[jump target="*choice"]
;;----------------------------medi------------------------------------------------------------
...
Vật phẩm hiện có - Hoa hồng([emb exp="f.flower"]), Hoa xanh([emb exp="f.flower_b"]), thuốc chữa cảm lạnh: ([font color="0x05ffff"][emb exp="f.drugk_c"][resetfont]), Thuốc chữa cảm nhiệt: ([font color="0xff0000"][emb exp="f.drugk_h"][resetfont]).
...
Tôi sẽ pha cho Sylvie 1 ly trà hoa xanh.[l_] Hoa xanh có công hiệu tốt trong việc điều trị [font color="0xff0000"]cảm nhiệt[resetfont].[p_]
...
[stopbgm] [cm] [black]
[if exp="f.bad_lv>=300"]
[jump target="*die_"][endif]
[iscript]
f.talk=Math.floor(Math.random() * 3 + 1);
[endscript]
[if exp="f.bad_lv>=250 && f.talk>=2"]
...
[if exp="f.hp<=50"][eval exp="f.hp=50"][endif]
...
Cô ấy đã trút hơi thở cuối cùng,[l_] Trong thời gian này, tôi vô cùng đau buồn,[l_]Đó là một sự mất mát lớn với tôi.[lr_]
Trong quãng thời gian sau này, tôi không biết mình sẽ phải sống ra sao nữa.[p_]
...[p_]
Có lẽ...[lr_]
Có lẽ tôi sẽ rời khỏi nơi này...[l_]
Đến một nơi nào đó....[l_]để quên đi sự việc đau thương này[p_]
...[p_]
...
...[p_]
Bệnh của Sylvie đã chuyển biến theo chiều hướng xấu đi.[lr_]
Tôi đã không chăm sóc cô ấy cẩn thận trong suốt thời gian này nên sức khỏe của Sylvie ngày một suy giảm.[p_]
[mes_hide]
[layopt layer="message0" visible=false][delay speed=17]
[position width=1270 height=865 top=25 left=50 ]
[position page=fore frame="00.png" margint=20 marginl=20 marginr=20 marginb=50 vertical=false opacity="90" color="0x000000"]
